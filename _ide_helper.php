...
namespace {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         * @static 
         */
        public static function basic($field = 'emails', $extraConditions = array()){
         ...
         * @static 
         */
        public static function onceBasic($field = 'emails', $extraConditions = array()){
    ...
    class jDate extends \Morilog\Jalali\Facades\jDate{
         ...
         * @static 
         */
        public static function format($str, $convertNumbersToPersian = false){
            return \Morilog\Jalali\jDate::format($str, $convertNumbersToPersian);
        }
        ...
        public static function parseFromFormat($format, $date){
            return \Morilog\Jalali\jDate::parseFromFormat($format, $date);
        }
        ...
        public static function dateTimeFromFormat($format, $str){
            return \Morilog\Jalali\jDate::dateTimeFromFormat($format, $str);
        }
        
    }


    class jDateTime extends \Morilog\Jalali\Facades\jDateTime{
        ...
        public static function date($format, $stamp = false, $convert = null, $jalali = false, $timezone = null){
            return \Morilog\Jalali\jDateTime::date($format, $stamp, $convert, $jalali, $timezone);
        }
        ...
        public static function gDate($format, $stamp = false, $timezone = null){
            return \Morilog\Jalali\jDateTime::gDate($format, $stamp, $timezone);
        }
        ...
        public static function strftime($format, $stamp = false, $jalali = null, $timezone = null){
            return \Morilog\Jalali\jDateTime::strftime($format, $stamp, $jalali, $timezone);
        }
        ...
        public static function mktime($hour, $minute, $second, $month, $day, $year, $jalali = null, $timezone = null){
            return \Morilog\Jalali\jDateTime::mktime($hour, $minute, $second, $month, $day, $year, $jalali, $timezone);
        }
        ...
        public static function checkdate($month, $day, $year, $jalali = null){
            return \Morilog\Jalali\jDateTime::checkdate($month, $day, $year, $jalali);
        }
        ...
        public static function toJalali($g_y, $g_m, $g_d){
            return \Morilog\Jalali\jDateTime::toJalali($g_y, $g_m, $g_d);
        }
        ...
        public static function toGregorian($j_y, $j_m, $j_d){
            return \Morilog\Jalali\jDateTime::toGregorian($j_y, $j_m, $j_d);
        }
